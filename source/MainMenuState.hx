...
{
	public static final kadeEngineVersion:String = "1.1.2";
	public static final psychEngineVersion:String = '0.6.3'; //Used in ke mode only lmao //This is also used for Discord RPC
	public static final modVersion:String = '2.2.0.demo'; //major.minor.patch :) //used in updates and main menu
	public static final galaxyEngineVersion:String = '0.5.0'; //major.minor.patch :) //used in main menu
	public static final displayVersion:String = 'Demo V2';
	public static var curSelected(default, set):Int = 0;

	public static function set_curSelected(v:Int):Int
	{
		if (v != curSelected)
	...
	override function create()
	{
		...
		var versionShitText:String = "";
		versionShitText += "Super Funkin' Galaxy " + displayVersion + " (v" + CoolUtil.getDisplayVersion(CoolUtil.parseVersion(modVersion)) + ")";
		versionShitText += "\nGalaxy Engine v" + CoolUtil.getDisplayVersion(CoolUtil.parseVersion(galaxyEngineVersion));

		var versionShit:FlxText = new FlxText(5, FlxG.height, 0, versionShitText, 20);
